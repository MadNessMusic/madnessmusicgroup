const playlists = [
  {
    ...
    description: "Descubre nuevos talentos del urbano latino. Reggaeton, trap latino y sonidos comerciales emergentes. Curaduria editorial por MadNess Music Group. Updated weekly.",
    seo: {
      title: "MadNess Discover - Nuevos sonidos latinos | MadNess Music Group",
      description: "Descubre nuevos talentos del urbano latino. Reggaeton, trap latino y sonidos comerciales emergentes. Curaduria editorial por MadNess Music Group."
    },
  ...
  },
  {
    ...
    description: "Una seleccion sin fronteras donde todo convive: banda, reggaeton, trap y R&B en distintos idiomas y estilos.",
