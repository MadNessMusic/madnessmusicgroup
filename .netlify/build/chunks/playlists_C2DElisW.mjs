const playlists = [
  {
    ...
    description: "Descubre nuevos talentos del urbano latino. Reggaetón, trap latino y sonidos comerciales emergentes. Curaduría editorial por MadNess Music Group. Updated weekly.",
    seo: {
      title: "MadNess Discover – Nuevos sonidos latinos | MadNess Music Group",
      description: "Descubre nuevos talentos del urbano latino. Reggaetón, trap latino y sonidos comerciales emergentes. Curaduría editorial por MadNess Music Group."
    },
  ...
  },
  {
    ...
    description: "Radar semanal de nuevos sonidos latinoamericanos y globales curados por MadNess Music Group.",
    seo: {
  ...
  },
  {
    ...
    description: "Una selección sin fronteras donde todo convive: banda, reggaetón, trap y R&B en distintos idiomas y estilos.",
  ...
  },
  {
    ...
    status: "evergreen",
    title: "MadNess Radar",
    description: "Radar curatorial de lanzamientos emergentes y tendencias actuales.",
  ...
  },
  {
    ...
    title: "Pop Codes",
    genre: ["Pop"],
    description: "Claves del pop global y latino: hooks, estructuras y sonidos que definen la cultura actual.",
